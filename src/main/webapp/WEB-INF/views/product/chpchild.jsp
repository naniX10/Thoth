...
<%-- 페이지 링크 --%>
<c:set var="pglink" value="/product/chpchild?cp="/>

<%-- 페이지 링크2 - 검색 --%>
<c:if test ="${not empty param.findkey}">
    <c:set var="pglink" value="/product/chfindchild?findtype=${param.findtype}&findkey=${param.findkey}&cp="/>
</c:if>
...
<div id="main" class="container">
    ...
    <div class="row">
        ...
        <div class="col-9">
            <div class="container">
                <div class="row">
                    <div class="col"><div class="Titletext">어린이</div></div>
                    <div class="col ">
                ...
                <div class="row">
                    <div class="col" id="searchArea">
                        ...
                        <button type="button"  class="btn" id="chsearchInbtn">검색</button>
                        <button type="button" class="btn newPbtn" id="chnewPbtn">상품등록</button>
                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row listAImage">
                                ...
                                <c:if test="${not empty p.image}">
                                    <a href="/product/chpviewchild?tnum=${p.tnum}">
                                ...
                                <c:if test="${empty p.image}">
                                    ...
                                    <c:if test="${f ne '-'}">
                                        ...
                                        <a href="/product/chpviewchild?tnum=${p.tnum}"><img src="${baseURL}${fname}${p.uuid}.${fext}" alt="도서이미지2" width="100px" height="150px"></img></a>
                                    </c:if>
                                </c:if>
                                </div>
                            </div>
                            <div class="row listA">
                                <div class="col">
                                    <a href="/product/chpviewchild?tnum=${p.tnum}">${p.title}</a>
                                </div>
