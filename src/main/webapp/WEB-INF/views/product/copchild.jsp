...
<%-- 페이지 링크 --%>
<c:set var="pglink" value="/product/copchild?cp="/>

<%-- 페이지 링크2 - 검색 --%>
<c:if test ="${not empty param.findkey}">
    <c:set var="pglink" value="/product/cofindchild?findtype=${param.findtype}&findkey=${param.findkey}&cp="/>
</c:if>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col" id="searchArea">
                        ...
                        <button type="button"  class="btn" id="cosearchInbtn">검색</button>
                        <button type="button" class="btn newPbtn" id="conewPbtn">상품등록</button>
                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row listAImage">
                                ...
                                <c:if test="${not empty p.image}">
                                    <a href="/product/copviewchild?tnum=${p.tnum}">
                                ...
                                <c:if test="${empty p.image}">
                                    ...
                                    <c:if test="${f ne '-'}">
                                        ...
                                        <a href="/product/copviewchild?tnum=${p.tnum}"><img src="${baseURL}${fname}${p.uuid}.${fext}" alt="도서이미지2" width="100px" height="150px"></img></a>
                                    </c:if>
                                </c:if>
                                </div>
                            </div>
                            <div class="row listA">
                                <div class="col">
                                    <a href="/product/copviewchild?tnum=${p.tnum}">${p.title}</a>
                                </div>
