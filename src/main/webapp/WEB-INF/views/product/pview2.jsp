        ...
        <div class="col-9">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <button type="button" class="listPbtn float-right" id="list2Pbtn">목록보기</button>
                        <span class="float-right">&nbsp;</span>
                        <button type="button" class="delPbtn float-right" id="delPbtn2">상품삭제</button>
                        <span class="float-right">&nbsp;</span>
                        <button type="button" class="modPbtn float-right" id="modPbtn2">상품수정</button>
                    </div>
                </div>
                <!-- 지은이, 출판사 -->
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn buy4Pbtn float-right" id="buy4Pbtn">바로구매</button>
                        <span class="float-right">&nbsp;</span>
                        <button type="button" class="btn buy3Pbtn float-right" id="buy3Pbtn">장바구니</button>
