        ...
        <div class="col-9">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <button type="button" class="listPbtn float-right" id="colistPbtn">목록보기</button>
                        <span class="float-right">&nbsp;</span>
                        <button type="button" class="delPbtn float-right" id="codelPbtn">상품삭제</button>
                        <span class="float-right">&nbsp;</span>
                        <button type="button" class="modPbtn float-right" id="comodPbtn">상품수정</button>
                    </div>
                </div>
                <!-- 지은이, 출판사 -->
                <div class="row">
