        ...
        <div class="col-9">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <button type="button" class="listPbtn float-right" id="chlistPbtn">목록보기</button>
                        <span class="float-right">&nbsp;</span>
                        <button type="button" class="delPbtn float-right" id="chdelPbtn">상품삭제</button>
                        <span class="float-right">&nbsp;</span>
                        <button type="button" class="modPbtn float-right" id="chmodPbtn">상품수정</button>
                    </div>
                </div>
                <!-- 지은이, 출판사 -->
                <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn chbuy2Pbtn float-right" id="chbuy2Pbtn">바로구매</button>
                        <span class="float-right">&nbsp;</span>
                        <button type="button" class="btn chbuy1Pbtn float-right" id="chbuy1Pbtn">장바구니</button>
